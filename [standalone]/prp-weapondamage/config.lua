...
Config.Weapons = {
    ...
    [`WEAPON_KNUCKLE`] = {model = `WEAPON_KNUCKLE`, modifier = 0.4, disableCritical = true},
    ...
    [`WEAPON_BZGAS`] = {model = `WEAPON_BZGAS`, modifier = 5.5, disableCritical = false},
    ...
    [`WEAPON_DE`] = {model = `WEAPON_DE`, modifier = 1.0, disableCritical = true},
   --[[  [`WEAPON_SNSPISTOL`] = {model = `WEAPON_SNSPISTOL`, modifier = 0.1, disableCritical = true}, ]]
    [`WEAPON_HEAVYPISTOL`] = {model = `WEAPON_HEAVYPISTOL`, modifier = 1.1, disableCritical = true},
    [`WEAPON_VINTAGEPISTOL`] = {model = `WEAPON_VINTAGEPISTOL`, modifier = 0.1, disableCritical = true},
    [`weapon_pumpshotgun`] = {model = `weapon_pumpshotgun`, modifier = 0.4, disableCritical = true},
    ...
    [`WEAPON_MICROSMG`] = {model = `WEAPON_MICROSMG`, modifier = 0.4, disableCritical = true},
    [`WEAPON_MINISMG`] = {model = `WEAPON_MINISMG`, modifier = 0.3, disableCritical = true},
    [`WEAPON_SMG`] = {model = `WEAPON_SMG`, modifier = 0.6, disableCritical = true},
  ...
  --[[   [`WEAPON_COMBATMG`] = {model = `WEAPON_COMBATMG`, modifier = 0.1, disableCritical = true}, ]]
   --[[  [`WEAPON_COMBATMG_MK2`] = {model = `WEAPON_COMBATMG_MK2`, modifier = 0.1, disableCritical = true}, ]]
    ...
    [`WEAPON_MACHINEPISTOL`] = {model = `WEAPON_MACHINEPISTOL`, modifier = 0.40, disableCritical = true},
}